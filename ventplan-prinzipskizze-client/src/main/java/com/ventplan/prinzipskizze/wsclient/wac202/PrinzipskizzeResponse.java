...
/**
 * <p>Java-Klasse für prinzipskizzeResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="prinzipskizzeResponse">
 *   &lt;complexContent>
...
@XmlType(name = "prinzipskizzeResponse", propOrder = {
    "_return"
})
public class PrinzipskizzeResponse {
